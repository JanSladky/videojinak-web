  ...
  return (
    <div className="px-6 py-12 max-w-4xl mx-auto text-center space-y-6">
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-4 max-w-md mx-auto text-left">
        {activeTab === "svatebni" ? (
          <>
            <input type="text" name="name" autoComplete="name" placeholder="Vaše jméno" value={formWedding.name} onChange={handleChange} required className="w-full p-3 border rounded" />
            <input type="email" name="email" autoComplete="email" placeholder="Váš e-mail" value={formWedding.email} onChange={handleChange} required className="w-full p-3 border rounded" />
            <input type="tel" name="phone" autoComplete="tel" placeholder="Telefonní číslo" value={formWedding.phone} onChange={handleChange} required className="w-full p-3 border rounded" />
            <span className="block mb-1 font-medium">Datum svatby</span>
            <input type="date" name="wedding_date" autoComplete="off" value={formWedding.wedding_date} onChange={handleChange} required className="w-full p-3 border rounded" />
          ...
          <>
            <input type="text" name="company_name" autoComplete="organization" placeholder="Název firmy" value={formCompany.company_name} onChange={(e) => handleChange(e, true)} required className="w-full p-3 border rounded" />
            <input type="email" name="email" autoComplete="email" placeholder="Váš e-mail" value={formCompany.email} onChange={(e) => handleChange(e, true)} required className="w-full p-3 border rounded" />
            <input type="tel" name="phone" autoComplete="tel" placeholder="Váš telefon" value={formCompany.phone} onChange={(e) => handleChange(e, true)} required className="w-full p-3 border rounded" />
             <span className="block mb-1 font-medium">Datum akce</span>
            <input type="date" name="event_date" autoComplete="off" value={formCompany.event_date} onChange={(e) => handleChange(e, true)} required className="w-full p-3 border rounded" />
